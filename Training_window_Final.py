...
class Training_window(QWidget):
    ...
    def init_window(self):
        ...
        self.setWindowIcon(QtGui.QIcon("D:\Image-Counterfeit-Detection-using-Deep-learning-master\Image-Counterfeit-Detection-using-Deep-learning-master\Icons\icons8-cbs-512.ico")) #icon Pic File name
        ...
        self.lr.setGeometry(QRect(440, 144, 70, 20))
        self.lr.setPlaceholderText("Learning Rate")

        # text Box
        self.ep = QLineEdit(self)
        self.ep.setFont(QtGui.QFont("Sanserif", 8))
        self.ep.setGeometry(QRect(440, 165, 70, 20))
        self.ep.setPlaceholderText("Epochs")

        #Button
        self.button_1 = QPushButton("Browse", self)
        self.button_1.setGeometry(QRect(450, 40, 90, 20))
        self.button_1.setToolTip("<h2>Browse image from your computer to start test!<h2>")  # Notice using h2 tags From Html
        self.button_1.setIcon(QtGui.QIcon("D:\Image-Counterfeit-Detection-using-Deep-learning-master\Image-Counterfeit-Detection-using-Deep-learning-master\Icons\\698831-icon-105-folder-add-512.png")) #icon Pic File name
        ...
        self.button_2.setToolTip("<h2>Browse image from your computer to start test!<h2>")  # Notice using h2 tags From Html
        self.button_2.setIcon(QtGui.QIcon("D:\Image-Counterfeit-Detection-using-Deep-learning-master\Image-Counterfeit-Detection-using-Deep-learning-master\Icons\\698831-icon-105-folder-add-512.png"))  # icon Pic File name
        ...
        self.button_3.setIcon(QtGui.QIcon("D:\Image-Counterfeit-Detection-using-Deep-learning-master\Image-Counterfeit-Detection-using-Deep-learning-master\Icons\create.png"))  # icon Pic File name
        ...
        self.button.setIcon(QtGui.QIcon("D:\Image-Counterfeit-Detection-using-Deep-learning-master\Image-Counterfeit-Detection-using-Deep-learning-master\Icons\\698827-icon-101-folder-search-512.png")) #icon Pic File name
        ...
        self.button.setToolTip("<h5>test image either Forged or Not Forged!<h5>")  # Notice using h2 tags From Html
        self.button.setIcon(QtGui.QIcon("D:\Image-Counterfeit-Detection-using-Deep-learning-master\Image-Counterfeit-Detection-using-Deep-learning-master\Icons\\repeat-pngrepo-com.png")) #icon Pic File name
        self.button.setIconSize(QtCore.QSize(15, 15))  # to change icon Size
        ...
        self.button_4.setIcon(QtGui.QIcon("D:\Image-Counterfeit-Detection-using-Deep-learning-master\Image-Counterfeit-Detection-using-Deep-learning-master\Icons\Rocket-icon-blue.png")) #icon Pic File name
        ...
        self.button.setIcon(QtGui.QIcon("D:\Image-Counterfeit-Detection-using-Deep-learning-master\Image-Counterfeit-Detection-using-Deep-learning-master\Icons\cancel-symbol-transparent-9.png")) #icon Pic File name
        self.button.setIconSize(QtCore.QSize(15, 15))  # to change icon Size
    ...
    def Make_CSV_file(self):
        if self.file_path_Tampered == "" or  self.file_path_Authentic == "":
            ...
            msg.setWindowIcon(QtGui.QIcon("D:\Image-Counterfeit-Detection-using-Deep-learning-master\Image-Counterfeit-Detection-using-Deep-learning-master\Icons\icons8-cbs-512.ico"))
            msg.exec_()
        else:
