...
class Test_window(QWidget):
    def __init__(self, parent = None , model_path = "D:\\Image-Counterfeit-Detection-using-Deep-learning-master\\Image-Counterfeit-Detection-using-Deep-learning-master" ):
        super().__init__()
    ...
    def init_window(self):
        ...
        self.button.setIcon(QtGui.QIcon("D:\Image-Counterfeit-Detection-using-Deep-learning-master\Image-Counterfeit-Detection-using-Deep-learning-master\Icons\\698831-icon-105-folder-add-512.png")) #icon Pic File name
