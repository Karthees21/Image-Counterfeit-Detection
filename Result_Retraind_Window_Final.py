...
class ResultWindow(QDialog):
    def __init__(self , label ="Not Forged" , prob = 0.50 , model_path = "D:\Image-Counterfeit-Detection-using-Deep-learning-master\Image-Counterfeit-Detection-using-Deep-learning-master\Source Code\sys_models" ,model_name = "ELA"):
        super().__init__()
        self.title = "Result"
        self.top = 700
        self.left = 1000
    ...
    def init_window(self,label , prob):
        ...
        self.setWindowIcon(QtGui.QIcon("D:\Image-Counterfeit-Detection-using-Deep-learning-master\Image-Counterfeit-Detection-using-Deep-learning-master\Icons\icons8-cbs-512.ico"))
        self.setGeometry(self.left, self.top, self.width, self.height)
        self.setFixedSize(self.width, self.height)
        hbox = QHBoxLayout()
        hbox.addStretch(1)
        m = PlotCanvas(self, width=12, height=10, dpi=80,label=label ,prob=prob)
        m.move(0,0)

        self.button_Test_again.setToolTip("<h5>to test Another image just Click Test button<h5>")
        self.button_Test_again.setIcon(QtGui.QIcon("D:\Image-Counterfeit-Detection-using-Deep-learning-master\Image-Counterfeit-Detection-using-Deep-learning-master\Icons\\698827-icon-101-folder-search-512.png"))
        ...
        self.button_quit.setIcon(QtGui.QIcon("D:\Image-Counterfeit-Detection-using-Deep-learning-master\Image-Counterfeit-Detection-using-Deep-learning-master\Icons\cancel-symbol-transparent-9.png"))
