...
class MainWindow(QWidget):
    def __init__(self, parent = None):
        """constructor to create a new window with characteristics after create object from class window"""
        super().__init__()
    ...
    def init_window(self):
        ...
        label = QLabel(self)
        label.move(20, 200)
        label.setText('Click training or testing to start:')
        label.setFont(QtGui.QFont("Sanserif", 8))

        pixmap = QPixmap("D:\Image-Counterfeit-Detection-using-Deep-learning-master\Image-Counterfeit-Detection-using-Deep-learning-master\Icons\icons8-cbs-512.png")
        ...
        self.button.setIcon(QtGui.QIcon("D:\Image-Counterfeit-Detection-using-Deep-learning-master\Image-Counterfeit-Detection-using-Deep-learning-master\Icons\start.png"))
